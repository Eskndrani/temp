...
static constexpr auto qt_meta_stringdata_ZN12InputManagerE = QtMocHelpers::stringData(
    "InputManager"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12InputManagerE[] = {
...
Q_CONSTINIT const QMetaObject InputManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12InputManagerE.offsetsAndSizes,
    qt_meta_data_ZN12InputManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12InputManagerE_t,
        // Q_OBJECT / Q_GADGET
...
void *InputManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12InputManagerE.stringdata0))
