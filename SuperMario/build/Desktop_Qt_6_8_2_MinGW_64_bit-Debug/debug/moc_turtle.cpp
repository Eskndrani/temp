...
namespace {
struct qt_meta_tag_ZN6TurtleE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6TurtleE = QtMocHelpers::stringData(
    "Turtle"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6TurtleE[] = {
...
Q_CONSTINIT const QMetaObject Turtle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6TurtleE.offsetsAndSizes,
    qt_meta_data_ZN6TurtleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6TurtleE_t,
        // Q_OBJECT / Q_GADGET
...
void *Turtle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6TurtleE.stringdata0))
