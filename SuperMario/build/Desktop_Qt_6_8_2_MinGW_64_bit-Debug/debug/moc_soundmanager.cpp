...
static constexpr auto qt_meta_stringdata_ZN12SoundManagerE = QtMocHelpers::stringData(
    "SoundManager"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12SoundManagerE[] = {
...
Q_CONSTINIT const QMetaObject SoundManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12SoundManagerE.offsetsAndSizes,
    qt_meta_data_ZN12SoundManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12SoundManagerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SoundManager, std::true_type>
    >,
    nullptr
} };
...
void *SoundManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12SoundManagerE.stringdata0))
