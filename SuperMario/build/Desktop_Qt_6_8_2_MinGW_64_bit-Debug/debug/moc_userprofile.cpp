...
#include "../../../LoginModule/userprofile.h"
...
static constexpr auto qt_meta_stringdata_ZN11UserProfileE = QtMocHelpers::stringData(
    "UserProfile"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11UserProfileE[] = {
...
Q_CONSTINIT const QMetaObject UserProfile::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11UserProfileE.offsetsAndSizes,
    qt_meta_data_ZN11UserProfileE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11UserProfileE_t,
        // Q_OBJECT / Q_GADGET
...
void *UserProfile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11UserProfileE.stringdata0))
